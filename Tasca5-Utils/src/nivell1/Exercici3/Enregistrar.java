...
public class Enregistrar {
    ...
    public static void printOrdenacio(String pathway){
        ...
        try (BufferedWriter output = new BufferedWriter( new FileWriter(currentDirectory + "/src/nivell1/Exercici3/emmagatzemar.txt", true))){
            ...
            if (folder != null) {
                output.write(folder.getName() + " Es un directori, pel que ordenarem tot el que hi té dins:");
