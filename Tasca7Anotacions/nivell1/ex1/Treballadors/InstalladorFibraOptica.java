...
public class InstalladorFibraOptica extends Treballador{

    private float kmRecorreguts;
    private float horesTreballadesPerSetmana;
    private float preuKilometre;
    public InstalladorFibraOptica(String nom, String cognom, float preuHora, float kmRecorreguts, float horesTreballadesPerSetmana){
    ...
    public void treballar(){
        System.out.println("Instal·lant fibra òptica");
    }
